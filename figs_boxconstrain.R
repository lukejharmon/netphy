...
### Symmetrical rates
results.symtrans <- read.table("results_symtrans_boxconstrain.txt", sep = "\t", header = FALSE)
results.symtrans <- results.symtrans[, -dim(results.symtrans)[2]]
names(results.symtrans) <- c("tree.number", "q01.sim", "q10.sim", "pSpec.sim", "lambda.sim", "ntaxa.sim", "q01.fit", "q10.fit", "pSpec.fit", "llik")
...
### Asymmetrical rates
results.asymtrans <- read.table("results_asymtrans_boxconstrain.txt", sep = "\t", header = TRUE)
results.asymtrans <- results.asymtrans[, -dim(results.asymtrans)[2]]
names(results.asymtrans) <- c("tree.number", "q01.sim", "q10.sim", "pSpec.sim", "lambda.sim", "ntaxa.sim", "q01.fit", "q10.fit", "pSpec.fit", "llik")
